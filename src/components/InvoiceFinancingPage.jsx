    ...
    return (
        <>
            ...
            <Helmet>
                ...
                <meta 
                    name="description" 
                    content="Get instant cash for your unpaid invoices. VePay offers interest-free invoice financing for Amazon sellers. Receive up to 70% advance within 24 hours. No hidden fees." 
                />
                <meta 
                    name="keywords" 
                    content="invoice financing, ecommerce funding, instant cash, working capital, Amazon seller, interest-free" 
                />
                <meta property="og:title" content="Invoice Financing | VePay - Instant Funding for eCommerce Sellers" />
                <meta 
                    property="og:description" 
                    content="Turn your invoices into instant cash with VePay's interest-free invoice financing. Get approved in 24 hours with zero interest." 
                />
